...
1. Clone the repository:
        ...
        git clone https://github.com/InternPulse/project-x-backend.git
...
1. Clone the repo `git clone https://github.com/InternPulse/project-x-backend.git`.
2. Open your terminal & set the origin branch: `git remote add origin https://github.com/InternPulse/project-x-backend.git`
